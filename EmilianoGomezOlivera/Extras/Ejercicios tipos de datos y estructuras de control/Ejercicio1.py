#Ejercicio 1:
# Escribí un programa que solicite al usuario ingresar un 
# número con decimales y almacenalo en una variable. A 
# continuación, el programa debe solicitar al usuario que 
...
# Por último, se debe mostrar en pantalla el texto “El 
# resultado de la suma es [suma]”, donde “[suma]” se 
